...
print("neighbors alive of TR: " + str(my_grid.corner_neighbors_alive_count(0,height-1)))
print("neighbors alive of BL: " + str(my_grid.corner_neighbors_alive_count(width-1,0)))
